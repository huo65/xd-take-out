...
public class ShoppingCartController {
    ...
    @PostMapping("/sub")
    public GeneralResult<ShoppingCart> sub(@RequestBody ShoppingCart shoppingCart) {
        Long dishId = shoppingCart.getDishId();
        ...
        if (dishId != null) {
            ...
            return GeneralResult.success(dishCart);
        }
        ...
        if (setmealId != null) {
            ...
            return GeneralResult.success(setmealCart);
        }
        return GeneralResult.error("系统繁忙，请稍后再试");
    }
}